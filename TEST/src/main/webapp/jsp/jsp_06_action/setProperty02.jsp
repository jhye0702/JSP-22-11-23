...
<body>
	<%-- 
	setProperty 액션 태그에 자바빈즈 Person으로 아이디와 이름을 전달받아 출력하기
	
	1) 자바빈즈로 Person 클래스를 사용하도록 useBean 액션 태그를 작성
	2) useBean 액션 태그의 id 속성 값을 통해 
		자바빈즈 Person의 프로퍼티 id와 name에
		값을 저장하도록 setProperty 액셕 태그를 작성
	3) useBean 액션 태그의 id 속성값을 통해 
		Person 클래스의 프로퍼티 id와 name의 값을 가져와
