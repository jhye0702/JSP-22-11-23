...
<body>
	...
	<form action="./form03_Ex02_process.jsp" method="post">'
	
		<p> 오렌지 <input type="checkbox" name="orange" value="오렌지"> 
			사과 <input type="checkbox" name="apple" value="사과"> 
			바나나 <input type="checkbox" name="banana" value="바나나"> 
